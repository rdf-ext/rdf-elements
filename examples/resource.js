...
class ResourceExample extends LitElement {
...
window.customElements.define('resource-example', ResourceExample)

render(html`<resource-example></resource-example>`, document.querySelector('#resource'))
